        ...
        <HStack flexDir={{ base: "column", md: "row" }} gap={0} w={"90%"}>
          ...
          >
            <VStack align={"start"}>
              ...
              >
                `في عالم تتغير فيه القوانين وتتسارع فيه الإجراءات، برز سؤال بسيط
                لكنه محوري: هل يتمكن الجميع — مواطنين ومقيمين — من الوصول الفعلي
                إلى الخدمات القانونية؟ من هذا السؤال، بدأت رحلة "مساندة". خضنا
                بحثًا ميدانيًا، واستطلعنا آراء الناس، وواجهنا الحقائق: ·       
                صعوبة الوصول للمعلومة القانونية. ·        تردد وخوف من التعامل
                مع الجهات الرسمية. ·        عوائق اللغة، التكاليف، والوقت.
                ·        وغياب الثقة أو الفهم الكامل للإجراءات القانونية. من
                هنا، وُلدت "مساندة" — منصة رقمية قانونية وُضعت بعناية، لتكون
                حلًا واقعيًا ومتاحًا للجميع، بالشراكة مع جهة قانونية مرخصة. نحن
                لا نقدّم مجرد استشارات، بل نوفر تجربة قانونية شاملة تقوم
                على: الوضوح، الشفافية، الخصوصية، وسهولة الوصول. "مساندة" ليست
                بديلًا عن القانون، بل وسيلتك لفهمه، التعامل معه، والنجاح من
                خلاله — أينما كنت، وباللغة التي تفهمها، وبتكلفة تستطيع تحملها.`
              </Text>
            </VStack>
          </VStack>
        </HStack>
