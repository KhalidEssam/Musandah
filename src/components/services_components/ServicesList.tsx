...
const plans: PlanProbs[] = [
    {
        ...
        whofor: {
            en: "Ideal for Families needing ongoing legal support	Residents with more than one legal case 	Individuals preferring in -person alongside remote consultations 	Those seeking the highest level of legal safety and privacy   ",
            ar: "	العائلات التي تحتاج إلى دعم قانوني مستمر	المقيمين الذين يحتاجون تمثيلًا في أكثر من قضية	الأفراد الذين يفضلون الاستشارات الحضورية إلى جانب الرقمية	من يبحث عن أقصى قدر من الأمان القانوني والخصوصية",
        },
        features: [
            {
    ...
    },
    {
        ...
        whofor: {
            en: "	Individuals or small families facing moderate legal challenges 	Residents seeking periodic advice and limited representation 	Those who value balance between service and cost",
            ar: " 	الأفراد أو الأسر الصغيرة الذين يواجهون تحديات قانونية متوسطة	المقيمين الراغبين في استشارات دورية وتمثيل محدود 	من يفضل التوازن بين الخدمة والتكلفة"
        },
        info: {
    ...
    },
    {
        ...
        whofor: {
            en: "	Individuals with one legal case during the year 	Residents seeking language - appropriate, limited advice 	Those looking for affordable, reliable legal help",
            ar: "	الأفراد الذين يواجهون قضية قانونية واحدة خلال السنة 	المقيمين الذين يحتاجون استشارات قانونية محددة باللغة المناسبة 	من يبحث عن خدمة قانونية معتمدة بأسعار رمزية"
        },
        price: {
            en: "499",
            ar: "499",
